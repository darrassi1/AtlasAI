...
class Config:
    ...
    def set_logging_prompts(self, value):
        ...
        self.save_config()
    # Getter methods for inference settings
    def get_temperature(self):
        return self.config["INFERENCE_SETTINGS"]["TEMPERATURE"]

    def get_max_token(self):
        return self.config["INFERENCE_SETTINGS"]["MAX_TOKEN"]

    def get_top_p(self):
        return self.config["INFERENCE_SETTINGS"]["TOP_P"]

    # Setter methods for updating inference settings
    def set_temperature(self, temperature):
        self.config["INFERENCE_SETTINGS"]["TEMPERATURE"] = temperature
        self.save_config()

    def set_max_token(self, max_token):
        self.config["INFERENCE_SETTINGS"]["MAX_TOKEN"] = max_token
        self.save_config()

    def set_top_p(self, top_p):
        self.config["INFERENCE_SETTINGS"]["TOP_P"] = top_p
        self.save_config()
